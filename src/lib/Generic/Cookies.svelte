...
<div
	class="bg-white dark:bg-darkobject p-4 fixed text-sm bottom-8 rounded dark:text-darkmodeText left-1/2 -translate-x-1/2 border-gray-200 shadow-xl z-50 flex flex-col items-center xl:!flex-none"
